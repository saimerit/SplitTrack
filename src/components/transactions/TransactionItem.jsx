  ...
  return (
    <>
      ...
      <div 
        ...
        className="sm:hidden p-4 flex flex-row justify-between items-center hover:bg-gray-50 dark:hover:bg-gray-700 border-b border-gray-100 dark:border-gray-700 transition-colors cursor-pointer group"
      >
      ...
      <div className="hidden sm:flex p-4 flex-row justify-between items-start hover:bg-gray-50 dark:hover:bg-gray-700 border-b border-gray-100 dark:border-gray-700 transition-colors group">
