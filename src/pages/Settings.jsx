...
const Settings = () => {
  ...
  const handleRemoveMember = async (email) => {
    setModalConfig({
      isOpen: true, title: "Remove Member?", message: `Remove <strong>${email}</strong>?`, confirmInput: "REMOVE", confirmText: "Remove", onConfirm: async () => {
  ...
  const handleImportJSON = async (e) => {
    ...
    setModalConfig({
      isOpen: true, title: "Restore?", message: "Wipes data.", confirmInput: "DELETE ALL", confirmText: "Restore", onConfirm: async () => {
  ...
  const handleNuke = async (n) => {
    setModalConfig({
      isOpen: true, title: `Delete All ${n}?`, message: `Delete ALL ${n}?`, confirmInput: `DELETE ${n.toUpperCase()}`, confirmText: "Delete All", onConfirm: async () => {
  ...
  const handleEmptyTrash = async () => {
    setModalConfig({
      isOpen: true, title: "Empty Trash?", message: "Delete all?", confirmInput: "EMPTY", confirmText: "Empty", onConfirm: async () => {
  ...
  return (
    <div className="space-y-6 md:space-y-8 max-w-5xl mx-auto pb-20 animate-fade-in">
      ...
      <div className="bg-white dark:bg-gray-800 p-4 md:p-6 rounded-lg shadow border dark:border-gray-700">
        <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-4">Recurring Transactions</h3>
        <RecurringManager />
      </div>
